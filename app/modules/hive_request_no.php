...
$csv_file = DIR_RESULT."/${hive_uid}/result.csv";
$zip_file = DIR_RESULT."/${hive_uid}/${hive_id}.csv.zip";
...
//圧縮処理
if ( $shell_ret == 0 and $hive_compress == "Z" ){
	chdir(DIR_RESULT."/${hive_uid}");

	//ファイル圧縮
	$cmd=CMD_ZIP . " $tmp_file result.csv";
	print "INF:$cmd\n";
	exec($cmd,$result,$retval);
	print "INF:$cmd => $retval\n";
